...
### 1. Wisdom Libraries (`.brain/wisdom/`)
...
### 3. Intuition Framework (`.brain/principles.md` [P-INTUITION])

New section added to `.brain/principles.md`:
...
### 4. Updated `.brain/playbooks/build-from-intent.md`
...
1. Consult `.brain/wisdom/strategic_wisdom.md` (Sun Tzu #1: "Know yourself and the enemy")
2. Use `.brain/wisdom/risk_wisdom.md` for risk assessment
...
### During CODING Phase
10. Apply `.brain/wisdom/engineering_wisdom.md` triggers (complexity, optimization, etc.)
11. Follow `.brain/wisdom/design_wisdom.md` (readable code, meaningful names)
...
14. Apply `.brain/wisdom/risk_wisdom.md` for sensitive LEGOs
...
**Modified**:
- `.brain/principles.md` (added [P-INTUITION] section)
- `.brain/playbooks/build-from-intent.md` (Section 8 enhanced with wisdom consultation)
