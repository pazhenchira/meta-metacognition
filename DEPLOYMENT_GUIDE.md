...
│   ├── APP_ORCHESTRATION.md     # Generated orchestration plan
...
3. Generates `requirements.md` (refined requirements)
4. Generates LEGO architecture (`lego_plan.json`)
5. **Generates `APP_ORCHESTRATION.md`** (human-readable orchestration plan)
6. (Optional) Shows plan to user for approval if `require_lego_plan_approval: true`
7. Builds all components in parallel isolated sessions
8. Generates tests (unit, integration, system)
9. Creates documentation
10. Finalizes `APP_ORCHESTRATION.md` with execution results
11. Writes `.meta-version` and `.meta-manifest.json`
...
├── APP_ORCHESTRATION.md         # Generated orchestration plan ✨ NEW
├── .meta-version                # v1.3.0
├── .meta-manifest.json          # Generated files tracking
├── requirements.md              # Detailed requirements
├── lego_plan.json               # Architecture (machine-readable)
├── src/
...
- `APP_ORCHESTRATION.md` - Generated orchestration plan (app-specific, human-readable)
- `.meta-version` - Generated by meta-orchestrator
- `.meta-manifest.json` - Generated by meta-orchestrator
- `requirements.md` - Generated by meta-orchestrator
- `lego_plan.json` - Generated by meta-orchestrator (machine-readable)
- `orchestrator_state.json` - Generated execution state (ephemeral)
- `lego_state_*.json` - Generated LEGO states (ephemeral)
