...
**Version 2.0.27** | [Changelog](CHANGELOG.md) | [Deployment Guide](DEPLOYMENT_GUIDE.md)
...
└── (generated by meta-orchestrator):
    ...
    ├── essence.md                  ← What makes your app unique
    ├── requirements.md             ← Your app's requirements
...
**Current Version**: 2.0.27 (December 26, 2025)  
...
# 2. Run:
@workspace Act as meta-orchestrator. Upgrade this app to v2.0.27 (ENGINE UPGRADE MODE)
...
cat VERSION        # Shows current meta-orchestrator version (2.0.27)
```
