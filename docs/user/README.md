...
**Version 2.0.9** | [Changelog](CHANGELOG.md) | [Deployment Guide](DEPLOYMENT_GUIDE.md)
...
If MCP tools exceed `mcp_tool_timeout_seconds`, the orchestrator falls back to `codex-cli-parallel`.
