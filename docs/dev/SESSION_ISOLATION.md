...
**NOTE**: This document supplements `.brain/playbooks/build-from-intent.md` Section 8 with detailed implementation guidance for true session isolation.
...
1. `.brain/principles.md` - Global engineering principles
...
This document **extends** .brain/playbooks/build-from-intent.md Section 8. When implementing:

1. Follow .brain/playbooks/build-from-intent.md for overall pipeline flow
