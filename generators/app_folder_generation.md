...
In addition to the `.app/` structure above, generated projects MUST include these files at project root for nexus compatibility:

| File | Source | Notes |
|------|--------|-------|
| `essence.md` | Generated by Phase 1.8 (Essence Discovery) | Canonical identity — NOT a copy under .app/ |
| `.brain/config.yaml` | Generated from brain-config.template.yaml (Step 1, before .app/) | Must contain: `project.name`, `project.version`, `orchestrator.name` |
...
| `.brain/lessons.md` | Generated from lessons.template.md (Step 1, before .app/) | Empty initially; populated through use |
| `.brain/status.md` | Generated from status.template.md (Step 1, before .app/) | Session re-entrancy state |
| `.brain/principles.md` | Inlined from engine's principles (Step 1, before .app/) | Domain-adapted for the project |
...
- [ ] `essence.md` exists at project root (not just under .app/)
