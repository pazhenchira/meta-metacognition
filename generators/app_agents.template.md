...
This project structure was generated by:
- **Engine**: meta-metacognition
- **Version**: {ENGINE_VERSION}
- **Date**: {GENERATION_DATE}

To upgrade: Update the engine and run the upgrade process.
Current engine version: Check the engine's `.brain/config.yaml`.
This app version: Check `.brain/config.yaml` version field.
